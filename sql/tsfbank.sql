...
-- Database: `tsfbank`
--
CREATE DATABASE IF NOT EXISTS `id17279264_tsfbank` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `id17279264_tsfbank`;
...
(1, 'Rohit', 'rohit@gmail.com', 5500),
(2, 'Rohan', 'rohan@gmail.com', 3000),
...
('root', '[{\"db\":\"indian_bank\",\"table\":\"users\"},{\"db\":\"indian_bank\",\"table\":\"transaction\"}]');
...
('root', '2021-07-20 07:19:08', '{\"Console\\/Mode\":\"collapse\"}');
